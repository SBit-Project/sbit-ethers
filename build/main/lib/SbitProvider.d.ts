...
declare const SbitProvider_base: {
    new (...args: any[]): {
...
export declare class SbitProvider extends SbitProvider_base {
}
declare const SbitJsonRpcProvider_base: {
    new (...args: any[]): {
        sendAsync(payload: EIP1993RequestArguments, cb: Callback): void;
        handleRequest(payload: EIP1993RequestArguments, _: Callback, end: Callback): void;
        request(payload: EIP1993RequestArguments): Promise<unknown>;
...
export declare class SbitJsonRpcProvider extends SbitJsonRpcProvider_base {
}
declare const SbitWebSocketProvider_base: {
    new (...args: any[]): {
        sendAsync(payload: EIP1993RequestArguments, cb: Callback): void;
        handleRequest(payload: EIP1993RequestArguments, _: Callback, end: Callback): void;
        request(payload: EIP1993RequestArguments): Promise<unknown>;
...
export declare class SbitWebSocketProvider extends SbitWebSocketProvider_base {
}
...
declare const SbitProviderSubprovider_base: {
    new (...args: any[]): {
        sendAsync(payload: EIP1993RequestArguments, cb: Callback): void;
        handleRequest(payload: EIP1993RequestArguments, _: Callback, end: Callback): void;
        request(payload: EIP1993RequestArguments): Promise<unknown>;
...
export declare class SbitProviderSubprovider extends SbitProviderSubprovider_base {
}
