...
class IntermediateWallet extends abstract_signer_1.Signer {
    constructor(privateKey, provider) {
        ...
        if (isAccount(privateKey)) {
            ...
            if (address_1.getAddress(this.address) !== address_1.getAddress(privateKey.sbitAddress || privateKey.address)) {
                if (address_1.getAddress(transactions_2.computeAddress(this.publicKey)) === address_1.getAddress(privateKey.sbitAddress || privateKey.address)) {
