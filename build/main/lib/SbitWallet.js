...
class SbitWallet extends IntermediateWallet_1.IntermediateWallet {
    ...
    static fromEncryptedJsonSync(json, password) {
        return new SbitWallet(json_wallets_1.decryptJsonWalletSync(json, password));
    }
    /**
    ...
    static fromMnemonic(mnemonic, path, wordlist) {
        ...
        // @ts-ignore
        properties_1.defineReadOnly(hdnode, "sbitAddress", utils_3.computeAddress(hdnode.publicKey, true));
